...
public class ProvinciaRestController {
	...
	public ResponseEntity<?> findById(@PathVariable Long id) {
		...
		if (provincia == null) {
			response.put("mensaje", "La provincia con ID: " + id.toString() + " no existe en la BBDD");
	...
	public ResponseEntity<?> create(@RequestBody Provincia provincia) {
		...
		response.put("mensaje", "La provincia " + provinciaNew.getNombre() + " ha sido creado con éxito");
	...
	public ResponseEntity<?> update(@RequestBody Provincia provincia) {
		...
		if (provinciaActual == null) {
			response.put("mensaje", "Error: no se pudo editar la provincia con Id: "
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		try {
			...
			response.put("mensaje", "Error al elimimar la provincia de la BBDD");
			response.put("error", e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
